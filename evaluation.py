...
def do_python_eval(predict_folder, gt_folder, name_list, num_cls, task, threshold, printlog=False):
    ...
    if printlog:
        ...
        # print('\n======================================================')
        # print('%11s:%7.3f%%'%('mPrecision',mp*100))

        # print('\n======================================================')
        # for i in range(num_cls):
        #     if i%2 != 1:
        #         print('%11s:%7.3f%%'%(categories[i],recall[i]*100),end='\t')
        #     else:
        #         print('%11s:%7.3f%%'%(categories[i],recall[i]*100))
        # print('\n======================================================')
        # print('%11s:%7.3f%%'%('mRecall',mr*100))
...
def eval_in_script_dl(logger=None, eval_list='val', task='dl', name=None, dict_dir=None, gt_dir='./data/VOC2012/SegmentationClass'):
