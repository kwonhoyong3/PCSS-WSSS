...
if __name__ == '__main__':
    ...
    parser.add_argument('--scale', default=(0.6,1.2), type=parse_tuple) 

    # * Random Erase params
    parser.add_argument('--reprob', type=float, default=0.0, metavar='PCT',
                        help='Random erase prob (default: 0.25)')               # changed from 0.0
    ...
    parser.add_argument("--W", default=[2.0, 2.0], nargs='+', type=float)
    parser.add_argument("--fim_start_epo", default=2, type=int, help='first epoch for FIM process')
    parser.add_argument("--fim_interval_epo", default=3, type=int, help='FIM process interval')
    parser.add_argument("--mpc_cam_start_epo", default=0, type=int, help='first epoch of cam loss for MPC process')
    ...
    train_dataset,_ = utils.build_dataset_trm(is_train=True, args=args, gen_attn=False)
    ...
    src_file = "./train_PCSS.py"
    des_file = "./experiments/"+args.name+"/copy_train.py"
    shutil.copy(src_file,des_file)
