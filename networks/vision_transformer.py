...
class Attention(nn.Module):
    ...
    def forward(self, x):
        ...
        q, k, v = qkv[0], qkv[1], qkv[2] #B H N C//head

        attn = (q @ k.transpose(-2, -1)) * self.scale  # B x num_heads x N2 x N2
...
class Block(nn.Module):
    ...
    def forward(self, x):
        # o, weights, qkv = self.attn(self.norm1(x))
...
class PatchEmbed(nn.Module):
    ...
    """
    def __init__(self, img_size=224, patch_size=16, in_chans=384, embed_dim=768):
        super().__init__()
